...
const navbar = () => {
    ...
    return (
        <>
            ...
            <nav className={`w-full fixed px-5 lg:px-8 xl:px[8%] py-4 flex items-center justify-between bg-white/50 backdrop-blur-md z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm" : ""}`}>
                <a href='#top'>
                    <button className='text-2xl cursor-pointer mr-14 '>
                        Carl Elago
                    </button>
                </a>
                <ul className={`hidden md:flex items-center justify-center gap-6 lg:gap-8 rounded-full px-12 py-3 ${isScroll ? "bg-white shadow-sm bg-opacity-50" : ""}`}>
                    <li>
