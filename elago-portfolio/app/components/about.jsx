                        ...
                        >
                            {infoList.map(({ icon, iconDark, title, description }, index) => (
                                <motion.li
                                    ...
                                    whileTap={{ scale: 0.98 }}
                                    className='group relative overflow-hidden border border-gray-200 dark:border-gray-700 rounded-2xl p-8 cursor-pointer bg-white dark:bg-gray-800 hover:bg-gradient-to-br hover:from-white hover:to-gray-50/50 dark:hover:from-gray-800 dark:hover:to-gray-700/50 transform transition-all duration-700 ease-out hover:shadow-2xl hover:shadow-gray-200/50 dark:hover:shadow-gray-900/50 hover:border-gray-300 dark:hover:border-gray-600 before:absolute before:inset-0 before:bg-gradient-to-r before:from-blue-50/0 before:to-purple-50/0 hover:before:from-blue-50/30 hover:before:to-purple-50/30 dark:hover:before:from-blue-900/20 dark:hover:before:to-purple-900/20 before:transition-all before:duration-700'
                                >
